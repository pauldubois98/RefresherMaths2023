...
\begin{document}
	...
	\begin{itemize}
		...
		\item $\boldsymbol{x} \in \R^2$ such that $\boldsymbol{w}.\boldsymbol{x} - b > 0$
	\end{itemize}
	The goal is to find $\boldsymbol{w}$ and $b$ such that all points of the first class are in the first region, and all points of the second class are in the second region.
