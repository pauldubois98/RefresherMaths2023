...
\begin{document}
	...
	\begin{enumerate}
		\item Calculate the probabilities $P(Y=1|X)$ for each data point using the logistic regression model.
		...
		\item Calculate the total cost (log loss) for all data points.
		\item Use gradient descent or any other optimization method to find the values of $\beta_0$ and $\beta_1$ that minimize the total cost.
	\end{enumerate}
