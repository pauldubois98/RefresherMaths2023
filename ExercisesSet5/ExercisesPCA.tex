...
\begin{document}
	...
	Let $\mathcal{S} = \{ \mathbf{x}_1, \mathbf{x}_2, \mathbf{x}_3, \mathbf{x}_4, \mathbf{x}_5 \}$ be a set of $5$ points in $\mathbb{R}^3$.\\
	$\mathbf{x}_1 = \begin{pmatrix} 1 \\ 2 \\ 0.1 \end{pmatrix}$,
	$\mathbf{x}_2 = \begin{pmatrix} 2.5 \\ 4 \\ 0 \end{pmatrix}$,
	$\mathbf{x}_3 = \begin{pmatrix} 3 \\ 7 \\ -0.2 \end{pmatrix}$,
	$\mathbf{x}_4 = \begin{pmatrix} 5 \\ 8 \\ 0.1 \end{pmatrix}$,
	and $\mathbf{x}_5 = \begin{pmatrix} 5 \\ 9 \\ 0 \end{pmatrix}$.
