...
\begin{document}
	...
	\subsection{Step 3: Eigenvalues of the covariance matrix}
	\subsection{Step 4: Feature Vectors (principal components)}
	\subsection{Step 5: Recasting data on principal components axes}
