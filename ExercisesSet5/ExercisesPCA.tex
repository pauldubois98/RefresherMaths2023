...
\begin{document}
	...
	$\mathbf{x}_1 = \begin{pmatrix} 1 \\ 2 \\ 3 \end{pmatrix}$,
	$\mathbf{x}_2 = \begin{pmatrix} 2 \\ 4 \\ 6 \end{pmatrix}$,
	$\mathbf{x}_3 = \begin{pmatrix} 3 \\ 6 \\ 9 \end{pmatrix}$,
	$\mathbf{x}_4 = \begin{pmatrix} 4 \\ 8 \\ 12 \end{pmatrix}$,
	and $\mathbf{x}_5 = \begin{pmatrix} 5 \\ 10 \\ 15 \end{pmatrix}$.
